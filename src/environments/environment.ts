...
export const environment = {
  production: false,
  hmr       : false,
  server: 'http://192.168.0.104:8180/serviciosenlinea/api', // SERVICIOS EN LINEA PARA EL LOGIN
  serverBalance: 'http://10.22.117.79:8080/databalance/api/web', //PARA EL SISTEMA DEL DATABALANCE
    
  //server: 'http://vps-2d507f0e.vps.ovh.ca:8180/serviciosenlinea/api',
  //server: '/api/', // SERVICIOS EN LINEA PARA EL LOGIN
  firebase:{
