...
@Component({
  selector: 'app-reportgestionger',
  templateUrl: './reportgestionger.component.html',
  styleUrls: ['./reportgestionger.component.scss']
})
export class reportGestionGerComponent implements OnInit {
  page = 1;
  pageSize = 10;
  collectionSize = 1;
...
return ;
      ...
      this.formService.generatereportger(this.companies, this.id_empresa, this.gestionForm.get('desde').value, this.gestionForm.get('hasta').value,'EXCEL').then(data => {
